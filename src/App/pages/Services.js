...
export default class Services extends React.Component {
  render() {
    return (
      <PortfolioWrapper>
        <Container>
          <Heading>Najja Construction Services</Heading>

          <Text>These are some of the services we provide.</Text>
          ...
          <Text>
            <ul>New Construction</ul>
            <ul>Remodelling/Renovations</ul>
            <ul>Mold remediation/ Removal</ul>
            <ul>Fire, Water, Storm, Damage Restoration</ul>
            <ul>Landscaping/ Tree Removal</ul>
            <ul>Room Additions</ul>
            <ul>Roof repair</ul>
            <ul>Plumbing</ul>
            <ul>Electric</ul>
            <ul>Painting</ul>
